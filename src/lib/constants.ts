...
export const MED_RECORD_CONTRACT_ID =
  import.meta.env.VITE_MED_RECORD_CONTRACT_ID || '';

export const CONSORTIUM_CONTRACT_ID =
  import.meta.env.VITE_CONSORTIUM_CONTRACT_ID || '';

export const DATA_ACCESS_CONTRACT_ID =
  import.meta.env.VITE_DATA_ACCESS_CONTRACT_ID || '';
