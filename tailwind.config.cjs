...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        /* Helix-inspired gold + near-black design tokens */
      ...
      boxShadow: {
        ...
        elevated: '0 2px 6px -2px rgb(0 0 0 / 0.4), 0 18px 44px -14px rgb(0 0 0 / 0.6), inset 0 1px 0 0 rgb(255 255 255 / 0.06)',
      ...
      keyframes: {
        ...
        'aurora-a':   { '0%,100%': { transform: 'translate(0,0) scale(1)' }, '50%': { transform: 'translate(12%,10%) scale(1.18)' } },
        'aurora-b':   { '0%,100%': { transform: 'translate(0,0) scale(1)' }, '50%': { transform: 'translate(-12%,8%) scale(1.12)' } },
        'aurora-c':   { '0%,100%': { transform: 'translate(0,0) scale(1.05)' }, '50%': { transform: 'translate(9%,-11%) scale(1.22)' } },
